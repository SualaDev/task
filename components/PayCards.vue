  ...
  <div class="paycard">
    <!-- <div class="paycard"> -->
      <div class="childcard">
        <div class="first">
          <p>Starter</p>
          <p>$69<span class="m">/mo</span></p>
        </div>
        <div class="second">
          <div class="in">
            <img src="~assets/images/check.svg" alt="">
            <p>Core Chat Features </p>
          </div>
          <div class="in">
            <img src="~assets/images/check.svg" alt="">
